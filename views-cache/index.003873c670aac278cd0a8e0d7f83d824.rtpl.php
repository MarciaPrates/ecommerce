<?php if(!class_exists('Rain\Tpl')){exit;}?><!-- Hero section -->
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="custom/img/bg.jpg">
				<div class="container">
					<div class="row">
			...
			<div class="hs-item set-bg" data-setbg="custom/img/bg-2.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-6 col-lg-7 text-white">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-4 p-0 feature">
					<div class="feature-inner">
						<div class="feature-icon">
							<img src="custom/img/icons/1.png" alt="#">
						</div>
				...
				<div class="col-md-4 p-0 feature">
					<div class="feature-inner">
						<div class="feature-icon">
							<img src="custom/img/icons/2.png" alt="#">
						</div>
						<h2>Frete Grátis</h2>
					</div>
				</div>
				<div class="col-md-4 p-0 feature">
					<div class="feature-inner">
						<div class="feature-icon">
							<img src="custom/img/icons/3.png" alt="#">
						</div>
		...
		<div class="container">
			...
			<div class="product-slider owl-carousel">
				<div class="product-item">
					<div class="pi-pic">
						<img src="custom/img/product/1.jpg" alt="">
						<div class="pi-links">
				...
				<div class="product-item">
					<div class="pi-pic">
						...
						<img src="custom/img/product/2.jpg" alt="">
						<div class="pi-links">
							<a href="#" class="add-card"><i class="flaticon-bag"></i><span>CARRINHO</span></a>
							<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
						</div>
				...
				<div class="product-item">
					<div class="pi-pic">
						<img src="custom/img/product/3.jpg" alt="">
						<div class="pi-links">
							<a href="#" class="add-card"><i class="flaticon-bag"></i><span>CARRINHO</span></a>
							<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
						</div>
				...
				<div class="product-item">
						<div class="pi-pic">
							<img src="custom/img/product/4.jpg" alt="">
							<div class="pi-links">
								<a href="#" class="add-card"><i class="flaticon-bag"></i><span>CARRINHO</span></a>
								<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
							</div>
				...
				<div class="product-item">
						<div class="pi-pic">
							<img src="custom/img/product/6.jpg" alt="">
							<div class="pi-links">
								<a href="#" class="add-card"><i class="flaticon-bag"></i><span>CARRINHO</span></a>
								<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
							</div>
	...
	<section class="banner-section">
		<div class="container">
			<div class="banner set-bg" data-setbg="custom/img/banner-bg.jpg">
