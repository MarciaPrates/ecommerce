		...
		<div class="container">
			...
			<div class="product-slider owl-carousel">
				<div class="product-item">
					<div class="pi-pic">
						<img src="custom/site/img/product/1.jpg" alt="">
						<div class="pi-links">
				...
				<div class="product-item">
					<div class="pi-pic">
						<img src="custom/site/img/product/3.jpg" alt="">
						<div class="pi-links">
							<a href="#" class="add-card"><i class="flaticon-bag"></i><span>CARRINHO</span></a>
							<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
						</div>
				...
				<div class="product-item">
						<div class="pi-pic">
							<img src="custom/site/img/product/4.jpg" alt="">
							<div class="pi-links">
								<a href="#" class="add-card"><i class="flaticon-bag"></i><span>CARRINHO</span></a>
								<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
							</div>
				...
				<div class="product-item">
						<div class="pi-pic">
							<img src="custom/site/img/product/6.jpg" alt="">
							<div class="pi-links">
								<a href="#" class="add-card"><i class="flaticon-bag"></i><span>CARRINHO</span></a>
								<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
							</div>
